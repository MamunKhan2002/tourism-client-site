...
const Navbar = () => {
    ...
    return (
        <div className={`${scrolling ? "top-0 duration-700 z-10" : "-top-20"} sticky bg-white shadow-md border-b border-black border-opacity-30 z-50`}>
            <div className="Navbar_container navbar relative">
                <div className="navbar-start">
                    ...
                    <div className={`absolute z-50 ${updateProfile ? "top-[85px] duration-300" : "-top-[200px] duration-300"}  right-[65px] p-4 bg-slate-500 bg-opacity-85 rounded-lg text-white flex flex-col justify-center items-center `}>
                        <h1>Abdullah</h1>
