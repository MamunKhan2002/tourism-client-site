    ...
    return (
        <div className="login_container flex rounded-2xl overflow-hidden shadow-lg bg-white  my-5">
            <div className="hidden lg:w-1/2 relative lg:flex items-center justify-center">
                <img className="h-full" src={login_image} alt="" />
            ...
            <div className="lg:w-1/2 container flex items-center justify-center px-6 pb-10 mx-auto">
                <form className="w-full max-w-md">
                    <div className="flex flex-col text-center">
                        <h1 className="text-3xl md:text-5xl font-bold text-blue-500 ">Welcome</h1>
                        <h3 className="md:text-base font-medium text-gray-300 mt-2">Login With Email</h3>
                    </div>
                    ...
                    <div className="mt-6">
                        ...
                        <div className="flex justify-center items-center gap-3">
                            <a href="#" className="flex items-center justify-center h-[40px] w-[40px] rounded-full mt-4 text-gray-600 transition-colors duration-300 transform border-2 border-blue-500 dark:text-gray-200 hover:bg-gray-50 dark:hover:bg-gray-600">
