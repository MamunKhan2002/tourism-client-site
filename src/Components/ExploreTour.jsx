    ...
    return (
        <div className='Explore_tour_container flex flex-col lg:flex-row md:gap-20 mb-16 md:mb-24 lg:mb-32'>
            ...
            <div className='lg:w-2/4'>
                ...
                {/* Button */}
                <a href="#_" className="relative my-10 inline-flex items-center px-12 py-3 overflow-hidden text-lg font-medium text-[#35A483] border-2 border-[#35A483] rounded-full hover:text-white group hover:bg-gray-50">
                    <span className="absolute left-0 block w-full h-0 transition-all bg-[#35A483] opacity-100 group-hover:h-full top-1/2 group-hover:top-0 duration-400 ease"></span>
